...
##  output:  the node dictionary
function create_reservoir(;name::String = "default_name", storage_capacity::Float64 = -999., 
    top_of_conservation::Array = fill(-999.,12), storage_units::String = "storage_units", 
    ID::Int64 = 999);

    return Dict("name" => name, "storage_capacity" => storage_capacity, 
